                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="img/a.jpg" style="width: 40px;">
                            </span>
                            <span class="username">Quang Nghia</span>
                            <b class="caret"></b>
                        </a>
        ...
        <?php
			...
			if(isset($_POST["process"]))
			{
				...
				move_uploaded_file($tmp_name,$path.$anh);
					$sql = "update users set anh = '$anh' where id ='$edit_id'";
                    ...
                    $sql = "update users set username = '$username'  , password = '$password',
                     email = '$email' , fullname = '$fullname' where id = '$edit_id' ";
                    mysqli_query($conn,$sql);
...
<div>
	...
	<form action="" method="post"  enctype="multipart/form-data">
		<table width="500"  border="1" style="margin: auto;">
			...
			<tr>
				<td>Ảnh</td>
				<td><input type="file" name="c_img" value="<?php echo $row['anh']; ?>"></td>
