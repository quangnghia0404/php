  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i> Tìm kiếm</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
              <li><i class="icon_document_alt"></i>Manage</li>
              <li><i class="fa fa-files-o"><a href="timkiem.php"></i>Tìm kiếm</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
        ...
        <div class="search" style="padding-left: 100px; margin-top: 20px;">
            ...
            <?php
                        ...
                        if(isset($_POST["search"]))
                        {
                            ...
                            $sql = "select * from users where username like '$name_search' ";
            ...
            <tr>
                <td style="text-align: center;" ><input type="text" name="nhap" size="100">
