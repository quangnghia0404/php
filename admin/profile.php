            ...
            <div class="profile-widget profile-widget-info">
              <div class="panel-body">
                ...
                <div class="col-lg-4 col-sm-4 follow-info">
                  <p>Hello I’m Nghia, a leading expert in interactive and creative design.</p>
                  <p>@dangquangnghia</p>
                  <p><a href="https://www.facebook.com/quang.nghia.1029/"></a><i class="fa fa-facebook">Quang Nghĩa</i></p>
                  <h6>
                                    <span><i class="icon_clock_alt"></i>11:05 AM</span>
                                    <span><i class="icon_calendar"></i>26.09.1999</span>
                                    <span><i class="icon_pin_alt"></i>VN</span>
                                </h6>
                </div>
                <div class="col-lg-2 col-sm-6 follow-info weather-category">
                  <ul>
                    <li class="active">
                      ...
                      <i class="fa fa-comments fa-2x"> </i><br> Trong cuộc sống, giai đoạn khó khăn nhất không phải là không ai hiểu bạn, mà là… bạn không hiểu chính mình.
                    </li>
                ...
                <div class="col-lg-2 col-sm-6 follow-info weather-category">
                  <ul>
                    <li class="active">
                      ...
                      <i class="fa fa-bell fa-2x"> </i><br> Người quan tâm đến tôi, tôi sẽ quan tâm lại gấp bội!
                    </li>
                ...
                <div class="col-lg-2 col-sm-6 follow-info weather-category">
                  <ul>
                    <li class="active">
                      ...
                      <i class="fa fa-tachometer fa-2x"> </i><br>Có những lúc, không có lần sau, không có cơ hội bắt đầu lại. Có những lúc, bỏ lỡ hiện tại, vĩnh viễn không còn cơ hội nữa.
                    </li>
                  ...
                  <div id="profile" class="tab-pane">
                    <section class="panel">
                      <div class="bio-graph-heading">
                        ...
                        Hello, I am Nghia a web developer and I am currently studying at Nha Trang University.
                        I like read book, plays music and play soccer...
                      </div>
                      <div class="panel-body bio-graph-info">
                        <h1>Bio Graph</h1>
                        <div class="row">
                          <div class="bio-row">
                            <p><span>First Name </span>: Đặng Quang </p>
                          </div>
                          <div class="bio-row">
                            <p><span>Last Name </span>: Nghĩa</p>
                          </div>
                          <div class="bio-row">
                            <p><span>Birthday</span>: 26 December 1999</p>
                          </div>
                          <div class="bio-row">
                            <p><span>Country </span>: Việt Nam</p>
                          </div>
                          <div class="bio-row">
                            <p><span>Occupation </span>:  Web Developer</p>
                          </div>
                          <div class="bio-row">
                            <p><span>Email </span>:dangquangnghia26091999@gmailcom</p>
                          </div>
                          <div class="bio-row">
