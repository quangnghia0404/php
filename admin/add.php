...
<body>
            ...
            <section class="wrapper">
				...
				if(isset($_POST["process"]))
				{
					...
					move_uploaded_file($tmp_name,$path.$anh);
						$sql = "insert into users(username,password,email,fullname,anh) values('$username','$password','$email','$fullname','$anh')";
	...
	<div class="haha">
		<div><h2 style="color: red; padding-top: 20px; text-align: center;">Thêm User</h2></div>
		<form action="" method="post"  enctype="multipart/form-data" >
			<table style="margin-left: 400px;"  >
				...
				<tr>
					...
					<tr>
					<td></td>
					<td><input type="submit" name="process" value="Thêm" ></td>
				</tr>
			</table>
		</form> 
	</div>
